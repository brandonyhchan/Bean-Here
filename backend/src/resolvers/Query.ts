...
/**
 * Verifys the user's credentials, signs them in to the application, and returns
...
/**
 * Retreives a list of cafes from the database based on the provided filters and 
